...
## [0.0.7](https://github.com/constructorfabric/cargo-gears/compare/cargo-gears-v0.0.6...cargo-gears-v0.0.7) - 2026-09-01

### Fixed

- *(lint)* consolidate package scope resolution (by @fdlockgraf)

### Other

- Improve lint package and feature selection (by @fdlockgraf) - #103
